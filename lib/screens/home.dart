...
class HomePageState extends State<HomePage> {
                ...
                child: Column(
                  children: [
                    ...
                    ListTile(
                      ...
                      onTap: () {
                        Navigator.pop(context);
                        Navigator.pushNamed(context, '/install-guide');
                      },
                    ),
                  ],
                ),
      ...
      builder: (_) => Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            const SizedBox(height: 8),
            Text(
              'Add Divido to your home screen for a better experience.',
              style: TextStyle(
  ...
  Widget _installStep(IconData icon, String platform, String instruction) {
    return Container(
