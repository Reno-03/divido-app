...
class _InstallNudgeCard extends StatefulWidget {
  const _InstallNudgeCard();

  @override
  State<_InstallNudgeCard> createState() => _InstallNudgeCardState();
}

class _InstallNudgeCardState extends State<_InstallNudgeCard> {
